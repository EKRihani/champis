...
#    extra_dependencies: ["float", "placeins", "svg", "amssymb", "amsmath"]
    ...
    toc: no
indent: true
bibliography: [Champis-CodeSourceBiblio.bib]
csl: https://www.zotero.org/styles/vancouver-superscript
---

```{r setup, include = FALSE, warning=FALSE}
load("EKR-Champis-CodeSource.RData")      # Chargement des résultats INTRO
...
```{r Lots-Chrono, echo = FALSE, fig.height = 3.5, fig.cap = paste0("Temps de calcul des principales distributions d'intérêt pour ", n_chrono, " facteurs, (", fois_chrono, " iter.)")}
...
```{r Lots-LoisBeta, echo = FALSE, fig.height = 3.5, fig.cap = "Distribution de différentes lois bêta, en fonction du facteur de croissance Fc"}
plot(lois_beta)
```
\paragraph*{}
