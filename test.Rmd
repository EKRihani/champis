...
output: 
  bookdown::pdf_document2: 
    number_sections: yes
    extra_dependencies: ["float", "placeins", "pdfpages", "svg", "amssymb", "amsmath", "sfmath", "alphalph", "slantsc", "subfigure"]
header-includes:
...
\begin{figure}
    \centering
        ...
        \caption{Arbres de classification optimisant la sensibilité (à g.) ou la spécificité (à d.)}
\end{figure}
...
\paragraph*{}
Un autre caractère assez évident est la forme du chapeau. La figure \ref{fig:AnatChapeaux} présente les formes de chapeau principales pour les sporophores dotés d'un stipe, mais bien d'autres géométries existent : consoles, croûtes...
\FloatBarrier
\begin{figure}
   \centering
