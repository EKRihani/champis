...
- Performances médiocres ($\kappa \ll 0.80 $), le modèle atteint ses limites.

## Forêts aléatoires

```{r, dev = "png", dev.args=list(bg="transparent"), fig.height = 5.8, fig.cap = "Performances des modèles Ranger (à g.) et Rborist (à d.) , en fonction de leurs hyperparamètres"}
ggarrange(
   ncol = 2,
