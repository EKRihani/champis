...
* \'Eviter un trop grand nombre de classes, dont certaines ne contiendraient qu'une espèce,
* Inversement, éviter d'avoir un nombre trop faible de classes, dont certains contiendraient un nombre considérable d'espèces.

\paragraph*{}
Nous avons donc retenu, pour cette étude, une classification plus souple -- et peut-être plus pragmatique -- qui est celle proposée dans le Photoguide du Pr Courtecuisse.[@courtecuisse_photo-guide_2000] Les familles représentées ici peuvent être retrouvées dans la matrice de confusion située à la fin de cette section (table \ref{tab:FAM-CM}, page \pageref{tab:FAM-CM}).
