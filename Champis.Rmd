...
\FloatBarrier
```{r, MULFAM2DRborist, echo = FALSE, fig.height = 4*.95, fig.width = 5.2*.95, dev = "jpeg", dpi = 600, fig.cap = "Performances du modèle Rborist dans une classification par familles, en fonction de ses deux hyperparamètres (interpolation Kriging quadratique, points expérimentaux encadrés en noir)"}
...
\paragraph*{}
Nous pouvons noter, comme précédemment, que si Rborist affiche des performances marginalement supérieures, le modèle Ranger s'est avéré sensiblement plus rapide sur des problèmes complexes.
