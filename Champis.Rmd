...
```{r, echo = FALSE, fig.height = 3, fig.cap = "Exemples de distributions de la loi uniforme (g.) et normale (d.)"}
plot(ggarrange(
   ncol = 2,
...
```{r, echo = FALSE, fig.height = 3, fig.cap = "Exemples de distributions de la loi de Poisson (g.) et bêta (d.)"}
plot(ggarrange(
   ncol = 2,
...
\paragraph*{}
Le premier critère n'est, en pratique, pas un facteur limitant, les temps de calcul pour la génération d'un nombre de facteurs de taille $F_{T}$ suffisant étant largement inférieurs à la seconde. 
...
```{r, echo = FALSE, fig.height = 4, fig.cap = "Distribution de différentes lois bêta, selon le facteur de croissance Fc"}
plot(lois_beta)
```
