...
$\overline{x_{i, n}}$ et $\overline{x_{i, m}}$ étant les moyennes respectives de chaque caractéristique $x_{i}$ pour les groupes (espèces) $n$ et $m$, et :
...
* Binomiale, loi discrète ne pouvant prendre que des valeurs entières, et qui peut être approximée par des lois continues telles que la loi normale ou la loi de Poisson,
...
$\overline{x_{i, n}}$ et $\overline{x_{i, m}}$ étant les moyennes respectives 
