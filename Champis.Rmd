...
\paragraph*{}
Les premiers modèles présentés dans le cadre de notre étude sont deux modèles CART (*Classification And Regression Tree*). The basic CART model (rpart) has one complexity parameter (cp).
