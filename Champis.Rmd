...
$$ S_{w} = Sen^{2w} . Spe^{2(1-w)} ~~~~~~~~ avec ~~~~ w \in \left[0;1\right]$$ 
<!-- 0 \leq w \leq 1 $$ -->
\paragraph*{}
Nous fixerons arbitrairement $w = 1/11$, soit $S_{w} = Sen^{2/11} . Spe^{20/11}$ ;ce qui revient à fixer dix ordres de grandeur entre l'importance accordée à la sensibilité et à la spécificité. 
<!-- x = 9/10 ou1/11 ... -->
\paragraph*{}
...
```{r, echo = FALSE, fig.height = 4, fig.cap = "Spécificité (à gauche) et sensibilité (à droite) de rpartCost en fonction de la complexité et du coût (interpolation quadratique, points expérimentaux encadrés en noir)"}
plot(ggarrange(
   ncol = 2,
...
```{r, echo = FALSE, fig.height = 4, fig.cap = "Spécificité (à gauche) et sensibilité (à droite) du modèle Rborist en fonction de ses deux hyperparamètres (interpolation quadratique, points expérimentaux encadrés en noir)"}
plot(ggarrange(
   ncol = 2,
...
```{r, echo = FALSE, fig.height = 4, fig.cap = "Spécificité (à gauche) et sensibilité (à droite) du modèle Ranger, en fonction des 2 hyperparamètres (algorithme de scission : gini)"}
plot(ggarrange(
   ncol = 2,
...
```{r, echo = FALSE, fig.height = 4, fig.cap = "Spécificité (à gauche) et sensibilité (à droite) du modèle Ranger, en fonction des 2 hyperparamètres (algorithme de scission : extratrees)"}
plot(ggarrange(
   ncol = 2,
...
plot(ggarrange(
   ncol = 2,
   MUL_fit_Rborist_spec_graphe + theme(legend.position="bottom"),
   MUL_fit_Rborist_sens_graphe + theme(legend.position="bottom")
   )
)
```
