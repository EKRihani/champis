...
\paragraph*{}
La première étape est de construire une fonction d'évaluation et de régression. La librairie caret permet de la définir très simplement par :  [A MODIFIER EN COHERENCE AVEC LE FICHIER R]
...
\FloatBarrier
```{r, echo = FALSE, fig.height = 3, fig.cap = "Specificité des modèles lda2 (à gauche) et pda (à droite)"}
plot(ggarrange(
   ncol = 2,
...
\FloatBarrier
```{r, echo = FALSE, fig.height = 3, fig.cap = "Specificity de gamLoess en fonction du span (gauche) and du degré (droite)"}
plot(ggarrange(
   ncol = 2,
