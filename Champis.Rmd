...
\FloatBarrier
Un autre caractère assez évident est la forme du chapeau. La figure \ref{fig:AnatChapeaux} présente les formes de chapeau principales pour les sporophores de champignon de morphologie agaricoïde,\footnote{La morphologie agaricoïde correspond à la "représentation habituelle" du champignon et se caractérise par la présence d'un chapeau, d'un stipe, et d'un hyménophore à lames.} mais bien d'autres géométries existent : consoles, croûtes...
\FloatBarrier
\begin{figure}
   \centering
...
La forme du stipe elle-même, ainsi que sa texture (fibreuse ou grenue), peuvent également fournir des indices utiles sur la famille de champignons.
