...
\paragraph*{}
\FloatBarrier
```{r, MULFAM2DRborist, echo = FALSE, fig.height = 4*.8, fig.width = 5.2*.8, dev = "jpeg", dpi = 600, fig.cap = "Performances du modèle Rborist dans une classification par familles, en fonction de ses deux hyperparamètres (interpolation Kriging quadratique, points expérimentaux encadrés en noir)"}
