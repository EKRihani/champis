...
\paragraph*{}
Certains contextes particuliers, tels que les tournois de *data science*, mettront en \oe{}uvre une quatrième fraction destinée au classement final des algorithmes (et des équipes). Certaines méthodes basées sur des plis multiples (*n-folds*) utilisent également une séparation flexible entre lots d'entraînement et de validation. Ces cas particuliers ne feront pas l'objet de cette étude.
\paragraph*{}
...
\paragraph*{}
Nous retiendrons dans le cadre de notre étude le kappa de Cohen, calculé à partir de la matrice de confusion, et donné par :
...
\paragraph*{}
Landis et Koch ont défini des
[ INSERER SCHEMA MATRICE DE CONFUSION ]

Source Kappa Cohen :
https://journals-sagepub-com.ressources-electroniques.univ-lille.fr/doi/abs/10.1177/001316446002000104


Grille validité Kappa Cohen (Landis & Koch) :
https://www-jstor-org.ressources-electroniques.univ-lille.fr/stable/2529310?searchText=The+Measurement+of+Observer+Agreement+for+Categorical+Data&searchUri=%2Faction%2FdoBasicSearch%3FQuery%3DThe%2BMeasurement%2Bof%2BObserver%2BAgreement%2Bfor%2BCategorical%2BData&ab_segments=0%2Fbasic_search_gsv2%2Fcontrol&refreqid=fastly-default%3A60efe6a1ae467d1002cd4305a15de703
