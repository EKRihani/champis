...
plot(ggarrange(
   ...
   fit_rpartcost_sens_graphe + ylab(NULL)
   )
)
```
...
plot(ggarrange(
   ncol = 2, widths = c(8,7),
   fit_ranger_Gini_spec_graphe,
   fit_ranger_Gini_sens_graphe + ylab(NULL)
   )
)
```
...
plot(ggarrange(
   ncol = 2, widths = c(8,7),
   fit_ranger_ET_spec_graphe,
   fit_ranger_ET_sens_graphe + ylab(NULL)
   )
)
```
