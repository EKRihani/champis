...
En pratique, l’algorithme de génération d’une forêt aléatoire, pour un lot de données structuré autour de $n$ observations et $p$ prédicteurs, fonctionne de la façon suivante :

1. Prélever un échantillon bootstrap\footnote{Le bootstrap correspond au à la constitution d’un échantillon par prélèvement d’individus *avec* remplacement.} de taille $n$,
