...
\paragraph*{}
Ce lot se concentrera exclusivement sur les champignons habituellement rencontrés au Nord de la France. Nombre de variétés, parfois très connues, ne sont donc pas présentes, parmi lesquelles nous pouvons par exemple citer les représentants du genre  *psilocybe*, connus pour leurs propriétés psychédéliques ou, plus proches de nous, celles du genre *tuber*\ : les truffes. 
\paragraph*{}
...
\paragraph*{}
```{r Lots-DispersionDensite, echo = FALSE, fig.height = 4.5, fig.cap = "Diagramme de densité de 2 paramètres de taille, avec dispersion, les dimensions "maximales" sont indiquées en pointillés rouges"}
plot(densite2d)
```
