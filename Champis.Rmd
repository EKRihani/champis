...
knitr::write_bib(c("tidyverse", "microbenchmark",  "caret",  "rmarkdown", "GGally", "plyr", "MASS", "mda", "rpart", "C50", "party", "ranger", "Rborist", "e1071", "rFerns", "knitr", "ggpubr", "SPlit", "DiceDesign", "DiceEval", "DiceKriging"), "packages.bib")
```
\pagestyle{plain}
...
\paragraph*{}
En l'espèce, l'index J de Youden pondéré nous permet donc de construire un indice synthétique nous permettant de considérer qu'il est bien plus grave de classer à tort comme comestible un champignon toxique que d'écarter à tort un champignon parfaitement comestible, sans pour autant autoriser le modèle à écarter un nombre inconsidéré de champignons comestibles.
\paragraph*{}
L'index J de Youden pondéré est donné par :
$ S_{w} = Sen^{2w} \times Spe^{2.(1-w)} ~~~~ avec~ 0  \in \left[ 0 ; 1 \right] $
