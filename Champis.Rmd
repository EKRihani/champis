...
avec $p(t)$ la fréquence relative de l'une des deux classes, au sein du n\oe{}ud considéré.
\paragraph*{}
Les arbres obtenus peuvent enfin être rationalisés à l'aide d'un algorithme d'élagage (*pruning*) visant à réduire la complexité de l'arbre. Cet algorithme effectue l'analyse de l'arbre des feuilles à la racine -- donc dans le sens inverse de l'induction qui l'a construit -- et en évaluant si chaque n\oe{}ud intermédiaire peut avantageusement être remplacé par une feuille ou par une branche. Différents critères d'optimisation existent, parmi lesquels nous pouvons citer l'élagage coût-complexité[@kretowski_evolutionary_2019], exploité par le modèle CART, et qui vise à minimiser le facteur coût-complexité $CC(T)$ de notre arbre $T$ :
...
* Modèle arborescent : *Classification And Regression Tree* (CART) (rpart, rpartCost)
...
2. Tester chaque combinaison de $n$ variables, à la recherche des valeurs pour lesquelles tous les champignons sont comestibles.
