...
https://pubmed.ncbi.nlm.nih.gov/23506596/
\paragraph*{}
...
```{r, echo = FALSE, fig.height = 4, fig.cap = "Performances (index de Youden pondéré 10:1) de rpartCost en fonction de la complexité et du coût (interpolation quadratique, points expérimentaux encadrés en noir)"}
