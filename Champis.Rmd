...
<!-- 0 \leq w \leq 1 $$ -->
\paragraph*{}
Nous fixerons arbitrairement $w = 3$, soit $S_{w} = Sen^{6} . Spe^{-4}$ ;ce qui revient à fixer dix ordres de grandeur entre l'importance accordée à la sensibilité et à la spécificité.
\paragraph*{}
