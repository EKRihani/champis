...
* Tendance à l’instabilité des structures arborescentes, même avec des perturbations mineures,
...
L’algorithme de génération d’une forêt aléatoire, pour un lot avec $n$ observations et $p$ prédicteurs, est le suivant :
...
2. Appliquer un partitionnement récursif sur cet échantillon bootstrap. A chaque n\oe{}ud, sélectionner aléatoirement $q$ parmi $p$ prédicteurs (avec $q 
3. Poursuivre le partitionnement récursif jusqu’à l’obtention d’un arbre.\footnote{cf. section \ref{chapitre:modeles_arbres}, page \pageref{chapitre:modeles_arbres}}
4. Répéter les étapes précédentes jusqu’à l’obtention d’une forêt. La classification par forêt se fait par un vote de tout les arbres.
