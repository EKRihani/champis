...
Certains modèles nécessiteront une optimisation de leurs paramètres de configuration (*hyperparamètres*). L'optimisation des paramètres expérimentaux relève du domaine des plans d'expérience. De nombreux plans et stratégies sont envisageables, le choix dépend en partie des caractéristiques du processus à optimiser.
\paragraph*{}
...
\paragraph*{}
Ces particularités imposent d'explorer de manière méthodique la totalité de l'espace expérimental.
\paragraph*{}
La méthode des hypercubes latins est une extension du principe des carrés latins.
