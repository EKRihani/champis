...
avec $S$ la somme des carrés intraclasse de $X$ (proportionnelle à la variance intraclasse) et $S_{pq}$ la somme des produits des caractéristiques pour chaque combinaison de paramètres $p$ et $q$.
\paragraph*{}
