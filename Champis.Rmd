...
L'impact de la dispersion sur la distribution des paramètres de taille est illustré par les figures \@ref(fig:Lots-Dispersion3D) et \@ref(fig:Lots-Dispersion2D).
...
Une simulation de Monte Carlo unidimensionnelle sur `r  n_champis` individus nous permet d'évaluer la proportion de spécimens "hors normes" à environ `r outliers_diam*100` % (cf. figure \@ref(fig:HorsNormes))
...
\subsubsection{Génération des paramètres qualitatifs}
texte

\FloatBarrier
\newpage
\section{Apprentissage machine et classification binaire}
texte

\FloatBarrier
\newpage
\section{Apprentissage machine et classification multiclasse}
texte

\FloatBarrier
\newpage
\section{Robustesse de la classification}
texte
