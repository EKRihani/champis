...
<!-- \paragraph*{} -->
<!-- De même, les graphiques de distribution des variables *cap.diameter* et *stem.height* en fonction des variables *veil.type* et *has.ring* montrent des distributions multimodales, qui mettront probablement en difficulté des modèles d'analyse discriminante linéaire, basées sur l'hypothèse de variables distribuées normalement -- ou a minima dotées de distributions monomodales.\footnote{cf. section  \ref{paragraphe:Modeles_LDA}, page \pageref{chapitre:LDA_limites}} -->
<!-- \paragraph*{} -->
