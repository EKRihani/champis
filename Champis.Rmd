...
* *kableExtra* pour la génération de tableaux
...
```
\normalsize
Les blocs de code sous R commencent et toutes par ```r, et se terminent par ```. Le préambule de chaque bloc de code indique toujours les paramètres utilisés pour le bloc en question, ici :
...
\paragraph*{}
La rédaction du texte peut commencer :
\small
```{r, eval = FALSE, highlight = FALSE}
# Principes de l'apprentissage machine
## Modèles utilisés
...
* *#, ##, ###* servent respectivement à indiquer des sections, sous-sections et sous-sous-sections, ils sont l'équivalent des commandes *\section*, *\subsection* et *\subsubsection* sous Latex,
