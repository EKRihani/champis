...
\paragraph*{}
De nombreux plans expérimentaux basés sur les hypercubes latins peuvent être générés. Nous pouvons en citer principalement trois :
* Carrés latins aléatoires
* Carrés latins optimisés, visant à optimiser l'occupation spatiale
* Carrés latins quasi-orthogonaux, visant à minimiser la corrélation des estimateurs des effets principaux.
