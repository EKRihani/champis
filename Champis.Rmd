...
<!-- 0 \leq w \leq 1 $$ -->
\paragraph*{}
En posant la toxicité en tant que valeur positive, nous pouvons donc fixer arbitrairement $w$ afin d'obtenir un index de Youden pondéré accordant dix ordres de grandeur entre l'importance accordée à la sensibilité et à la spécificité. Ce critère nous permet d'établir $w = 10/11$.
<!-- x = 10/11 ou 1/11 ... -->
\paragraph*{}
