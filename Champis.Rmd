...
* $i = 1$ pour la longueur de sépale,
* $i = 2$ pour la largeur de sépale,
* $i = 3$ pour la longueur de pétale,
* $i = 4$ pour la largeur de pétale.
...
\paragraph*{}
La valeur absolue de ces coefficients indique leur pondération dans l'indice $X$ qui permet une réduction de dimensionalité garantissant une séparation optimale, ainsi que l'illustre la figure \@ref(fig:LDA-MinMax).

```{r LDA-MinMax, echo = FALSE, fig.height = 2.5, fig.cap = "Distribution des variétés setosa et versicolor en fonction de leurs caractéristiques"}
plot(ggarrange(
   ncol = 2,
   iris_grapheMAX,
   iris_grapheMin
