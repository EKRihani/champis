...
#   - \usepackage{float}    # Pour placer ces %#@$§£ de floats
...
kable(BI_CM_ranger_final$table, caption = "Matrice de confusion du modèle Ranger (prédictions à gauche, références en haut)")
```  
