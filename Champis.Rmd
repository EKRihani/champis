...
3. Poursuivre le partitionnement récursif jusqu’à la formation d’un arbre\footnote{cf. section \ref{chapitre:modeles_arbres}, page \pageref{chapitre:modeles_arbres}} $\widehat{h}(., \Theta_{\ell}), 1 \leq \ell \leq q$,
