...
\paragraph*{}
Comme précédemment, nous pouvons proposer pour ce modèle la modélisation quadratique suivante\ :
$$ Y = b_{0} + b_{1}.X_{1} + b_{2}.X_{2} + b_{3}.X_{3} + b_{12}.X_{1}.X_{2} + b_{23}.X_{2}.X_{3} + b_{13}.X_{1}.X_{3} + b_{11}.X_{1}^{2} + b_{22}.X_{2}^{2}$$
...
\FloatBarrier
\paragraph*{}
Comme lors de la classification binaire, nous pouvons modéliser la réponse par un modèle quadratique avec interaction\footnote{cf. section \ref{chapitre:doe}, page \pageref{chapitre:doe}}\ :
$$ Y = b _{0} + b _{1}.X_{1} + b_{2}.X_{2} + b_{12}.X_{1}.X_{2} + b _{11}.X_{1}^{2} + b_{22}.X_{2}^{2}$$
...
\paragraph*{}
\paragraph*{}
Le calcul numérique des coefficients de la modélisation quadratique du kappa en fonction des hyperparamètres nous permet d'obtenir les estimations des effets suivantes\ :
\paragraph*{}
:::::: {.cols data-latex=""}
...
\paragraph*{}
Comme précédemment, le calcul numérique permet d'estimer les effets des hyperparamètres\ :
\paragraph*{}
:::::: {.cols data-latex=""}
