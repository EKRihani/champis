...
\paragraph*{}
L'ensemble des valeurs quantitatives possibles pour un critère et pour une variété donnés est inséré dans un vecteur de valeurs. Une valeur sera tirée aléatoirement, et de manière équiprobable, parmi celles contenues dans ce vecteur afin de caractériser le paramètre en question, et ce, pour chaque spécimen.
\paragraph*{}
...
# Annexe 2\ : Algorithmes d'apprentissage machine
...
\newpage
# Annexe 3\ : Langage de balisage Rmarkdown
