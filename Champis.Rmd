...
* \verb|kableExtra| pour la génération de tableaux
...
figure \ref{fig:Principe-LDA}).[@hastie_elements_2016] La LDA peut être utilisée 
à fins de classification, mais aussi pour effectuer des réductions de 
...
Le bloc suivant n'appelle pas à commentaires, étant constitué exclusivement de texte :
\small
```{r, eval = FALSE, highlight = FALSE}
\paragraph*{}
...
Nous pouvons ensuite introduire des notations mathématiques, toujours en notation Latex :
...
Les notations mathématiques utilisent globalement deux types de balises :
