...
```{r, echo = FALSE}
kable(MUL_fit_rpart_cp_resultats[,1:4], digits = 5, caption = "Performance du modèle CART (rpart)")
```
...
plot(ggarrange(
   ncol = 2,
   MUL_fit_ranger_Gini_sens_graphe,
