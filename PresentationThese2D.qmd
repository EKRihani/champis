...
```{r, dev = "png", dev.args=list(bg="transparent"), dpi = 100, fig.height = 5, fig.cap = paste0("Paramètres de taille (Ls et Dc), sans (à g.) et avec dispersion (à .), pour ", n_reduit, " champignons")}
plot(ggarrange(
   ncol = 2,
